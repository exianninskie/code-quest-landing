-- Migration 100: Deploy Chapter 5 - The Glitchy Grotto
-- Installs the debugging-focused chapter with 30 Fill-in-the-Blank puzzles.

DO $$
DECLARE
  ch5_id UUID;
BEGIN
  -- 1. Create Chapter 5: The Glitchy Grotto
  -- We delete any existing one at position 5 first to avoid conflicts.
  ...
  -- 2. Insert 30 "Fill in the Blank" Puzzles (Debugging focus)
